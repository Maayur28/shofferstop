...
const ProfileAddress = ({
  ...
  const getAddress = async (page, pageSize) => {
    ...
    const response = await fetchGet(
      "https://user.shofferstop.in/users/address?" +
        new URLSearchParams({
          page: page,
          pageSize: pageSize,
        }),
  ...
  const setAsDefault = async (addressId) => {
    ...
    const response = await updatefetchPut(
      `https://user.shofferstop.in/users/address/default/${addressId}?` +
        new URLSearchParams({
  ...
  const deleteAddress = async (addressId) => {
    ...
    const response = await fetchDelete(
      `https://user.shofferstop.in/users/address/${addressId}?` +
        new URLSearchParams({
          page: pagination.page,
          pageSize: pagination.pageSize,
        }),
  ...
  const searchCalled = async (val) => {
    setapiCalled(true);
    const response = await fetchGet(
      "https://user.shofferstop.in/users/address/search?" +
        new URLSearchParams({
          search: val,
          page: pagination.page,
          pageSize: pagination.pageSize,
