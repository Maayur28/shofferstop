...
import { fetchDelete, fetchGet, fetchPut } from "../FetchData";
                  ...
                  cartData.items.length > 0 ? (
                    <div className="cart">
                          ...
                          {cartData.items.map((productData, index) => (
                            ...
                            >
                              ...
                              <div
                                ...
                                onClick={() =>
                                  navigate(`/${productData.productName}`)
                                }
                              >
                                <Title level={3} style={{}}>
                                    ...
                                    >
                                      ...
                                      <div className="cart_product_detail">
                                        ...
                                        <div>
                                          <Text>Qty:&nbsp;</Text>
                                          <Badge
                                            count={productData.productQuantity}
                                          />
                                        </div>
                                      </div>
                                    </Card>
                      ...
                      <div className="cart_price">
                        <Card title="Price Details" className="cart_card_price">
                          <div
                            style={{
                              display: "flex",
                          ...
                          <div>
                            ...
                            {current === 1 && (
                              <div style={{ textAlign: "left" }}>
                                <Text type="warning">
                                  Default address is your delivery address
                                </Text>
                              </div>
                            )}
                          </div>
